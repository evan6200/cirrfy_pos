...
#define MX6Q_EVAN_DEF_ENET_PAD_TXC_CTRL  (PAD_CTL_PKE | PAD_CTL_PUE |    \
                PAD_CTL_PUS_100K_UP | PAD_CTL_SPEED_MED |       \
                PAD_CTL_DSE_EVAN_DEF_290ohm | PAD_CTL_HYS) 
//Evan modified Define in Reference Manual PAGE 2151
...
//Evan modified here 
#define _MX6Q_PAD_RGMII_TXC__ENET_RGMII_TXC                   \
                IOMUX_PAD(0x036C, 0xc058, 1, 0x0000, 0, 0)
...
#define  MX6Q_PAD_RGMII_TXC__ENET_RGMII_TXC           \
                (_MX6Q_PAD_RGMII_TXC__ENET_RGMII_TXC | MUX_PAD_CTRL(MX6Q_EVAN_DEF_ENET_PAD_TXC_CTRL)) //Evan modified.
